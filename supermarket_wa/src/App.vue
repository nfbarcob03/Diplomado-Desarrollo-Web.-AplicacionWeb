  ...
  <div id="app">
    <div class="header">
      ...
      <nav>
        ...
        <button v-on:click="compras" v-if="is_auth">Compras</button>
    ...
    <div class="footer">
      <h2>Diplomado en Desarrollo de Aplicaciones Web y Móviles</h2>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      products: function(){
       ...
       compras: function(){
        if(this.$route.name != "compras"){
          let username = localStorage.getItem("current_username")
          this.$router.push({name: "compras", params:{ username: username }})
        }
      },
